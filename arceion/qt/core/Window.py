...
class Window(QMainWindow):
	...
	def __init__(self, **__kwargs):
		...
		WinSigPool.themeChanged.connect(self.updateTheme)
	...
	def updateTheme(self) -> None:
		"""
		Updates the theme of the current view in the central widget.

		This method retrieves the current view from the central widget and calls its `updateTheme` method. If no view
		is currently displayed, it does nothing.
		"""
		if self.centralWidget.currentWidget():
